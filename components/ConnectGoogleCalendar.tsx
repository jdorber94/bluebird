  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <p className="text-gray-600 mb-6">
        Connect your Google Calendar to automatically import your scheduled demos and keep track of them.
      </p>
      ...
      <div className="mt-4 text-xs text-gray-500">
        <p>By connecting your Google Calendar, you grant ShowRate Manager permission to:</p>
        <ul className="list-disc pl-5 mt-2">
          <li>View your calendar events</li>
          <li>Detect demo appointments</li>
          <li>Send reminders to attendees</li>
        </ul>
      </div>
    </div>
  );
